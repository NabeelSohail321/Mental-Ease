...
class PhysicalAppointmentHistory extends StatelessWidget {
  const PhysicalAppointmentHistory({super.key});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => AppointmentProvider1(),
      child: Scaffold(
        body: SafeArea(
...
class _AppointmentHistoryBody extends StatelessWidget {
  ...
  Widget _buildStatusFilterChips(BuildContext context, double screenWidth, bool isPortrait) {
    final provider = Provider.of<AppointmentProvider1>(context);
  ...
  Widget _buildAppointmentCard(BuildContext context, AppointmentData appointment,
    ...
    final provider = Provider.of<AppointmentProvider1>(context, listen: false);
    Color statusColor;
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            provider.updateAppointmentStatus(
                                appointment.id, 'canceled',context);

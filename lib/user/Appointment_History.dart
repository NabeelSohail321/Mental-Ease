...
import 'Physical_Appointment_History.dart';
import 'online_appointment_history.dart';

class AppointmentHistory_Options extends StatelessWidget {
  @override
            ...
            child: Column(
              ...
              children: [
                _buildOptionCard(
                  ...
                  onTap: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) {
                      return PhysicalAppointmentHistory();
                    },));
                ...
                _buildOptionCard(
                  ...
                  onTap: () {
                   Navigator.push(context, MaterialPageRoute(builder: (context) {
                     return OnlineAppointmentHistory();
                   },));
                  },
                ),
